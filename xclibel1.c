/*
 *
 *	xclibel1.c	External	23-Jul-2015
 *
 *	Copyright (C)  2002-2014  EPIX, Inc.  All rights reserved.
 *
 ...
 *
 *	    gcc -DC_GNU64=400 -DOS_LINUX -I../.. xclibel1.c ../../xclib_x86_64.a -lm
 *
 *	Compile with GCC with PXIPL for 64 bit Linux as :
 *
 *	    gcc -DC_GNU64=400 -DOS_LINUX -I../.. xclibel1.c ../../pxipl_x86_64.a ../../xclib_x86_64.a -lm
 *
 *	Run as:
 *	    ./a.out
 *
